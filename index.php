...
<!--
	Author: Kolatech
	Developed By Kolatech Consultancy
	Author URL: http://kolatech.com.ng
-->
<!DOCTYPE html>
<html lang="en">
<head>
<title>Al-Ameen Comprehensive High School, Oyo</title>
<!-- Meta tag Keywords -->
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h2><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> Al-AMEEN Schools</a></h2>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="#services" class="effect-3 scroll">Admission</a></li>
						<li><a href="#team" class="effect-3 scroll">News</a></li>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>Al-Ameen Group of Schools was established in 1996 as Al-Ameen Nursery and Primary School and in 2006, 
					Al-Ameen Comprehensive High School was established. Over the years, We have achieved a lot of academic
					in the external Examinations like WAEC, NECO and JAMB. We have produced a lot of successful alumni
					in their chosen career such as Engineers, Doctors, Pharmacists, Nurses, Lawyers, Accountants, Economists,
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='6569' data-delay='.5' data-increment="10">6569</div>
				
				<h4 class="stats-info">OLD STUDENTS</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-book" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='4000' data-delay='.5' data-increment="10">4000</div>
				
				<h4 class="stats-info">APPLICANTS </h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-trophy" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='3000' data-delay='.5' data-increment="10">3000</div>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Our Experienced Teachers</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/t1.jpg" alt="">
				  <h5>Mr. Abdullah Ganiyu</h5>
				  <div class="about_opa">
					<p>Chemistry</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="facebook.com/abdullah.ganiyu1" target="blank"></a></li>
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					...
					<p>Mobalaje Area, Oyo, Oyo State</p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="contact-top1">
					<form action="#" method="post">
						...
						<div class="form-group">
							<label>Message*</label>
							<textarea placeholder name="Type your message here......" required=""></textarea>
						</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2024 Al-Ameen. All rights reserved | Designed by <a href="http://kolatech.com.ng">Kolatech.</a> Developed By Kolatech Consultancy</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2024 Al-Ameen. All rights reserved | Designed by <a href="http://kolatech.com">Kolatech.</a> Developed By Kolatech Consultancy</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
